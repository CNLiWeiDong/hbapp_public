...
namespace hb {
    namespace http {
        ...
        typedef std::function<void(const int &status, const std::string &response)>
            response_fun_type;
        ...
        class session : public std::enable_shared_from_this<session> {
          ...
          public:
            ...
            session(net::io_context &ioc, const beast::http::request<beast::http::string_body> req,
                    const response_fun_type &fun)
