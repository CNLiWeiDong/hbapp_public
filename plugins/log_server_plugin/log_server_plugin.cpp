...
namespace hb {
    namespace plugin {
        static appbase::abstract_plugin &_log_server_plugin
            = app().register_plugin<log_server_plugin>();
        log_server_plugin::log_server_plugin() {}
        log_server_plugin::~log_server_plugin() {}
        void log_server_plugin::set_program_options(options_description &cli,
                                                    options_description &cfg) {
            cfg.add_options()("log-server-udp-port",
                              boost::program_options::value<int>()->default_value(514),
                              "log-server-udp-port")(
                "log-server-msg-after",
                boost::program_options::value<string>()->default_value("msg->"),
                "log-server-udp-port");
        }
