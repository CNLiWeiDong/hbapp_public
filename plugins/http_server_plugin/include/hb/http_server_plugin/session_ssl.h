...
namespace hb {
    namespace http_server {
        ...
        class session_ssl : public std::enable_shared_from_this<session_ssl> {
            ...
            struct send_lambda {
                session_ssl& self_;
                explicit send_lambda(session_ssl& self) : self_(self) {}
                ...
                void operator()(http::message<isRequest, Body, Fields>&& msg) const {
                    ...
                    http::async_write(
                        self_.stream_, *sp,
                        beast::bind_front_handler(&session_ssl::on_write, self_.shared_from_this(),
                                                  sp->need_eof()));
                }
            };
          ...
          public:
            ...
            explicit session_ssl(tcp::socket&& socket, ssl::context& ctx,
                ...
                : stream_(std::move(socket), ctx), lambda_(*this), handle_(h) {
