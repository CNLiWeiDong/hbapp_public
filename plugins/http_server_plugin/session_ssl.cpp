    ...
    namespace http_server {
        ...
        void session_ssl::run() {
            ...
            net::dispatch(stream_.get_executor(),
                          beast::bind_front_handler(&session_ssl::on_run, shared_from_this()));
        }
        void session_ssl::on_run() {
            ...
            stream_.async_handshake(
                ...
                beast::bind_front_handler(&session_ssl::on_handshake, shared_from_this()));
        }
        ...
        void session_ssl::do_read() {
            ...
            http::async_read(stream_, buffer_, req_parser_,
                             beast::bind_front_handler(&session_ssl::on_read, shared_from_this()));
        }
        ...
        void session_ssl::on_write(bool close, beast::error_code ec,
