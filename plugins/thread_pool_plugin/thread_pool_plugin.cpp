...
namespace hb {
    namespace plugin {
        static appbase::abstract_plugin& _thread_pool_plugin
            = app().register_plugin<thread_pool_plugin>();
        thread_pool_plugin::thread_pool_plugin() {}
        thread_pool_plugin::~thread_pool_plugin() {}

        void thread_pool_plugin::set_program_options(options_description& cli,
                                                     options_description& cfg) {
            cfg.add_options()("thread-pool-count", bpo::value<int>()->default_value(32),
