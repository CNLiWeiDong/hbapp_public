...
namespace hb::plugin {
    ...
    void msg_security_plugin_impl::encrypt(const string &msg, string &chiper, string &encrypted_msg) {
        try {
    ...
    // return msg
    void msg_security_plugin_impl::decrypt(const string &encrypted_msg, const string &chiper, string &msg) {
        try {
